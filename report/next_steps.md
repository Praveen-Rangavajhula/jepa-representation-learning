...
- Review which candidate-generation strategies are easiest and hardest for the engineered scorer on Something-Something V2, or on UCF101 fallback if the primary path was unavailable.
